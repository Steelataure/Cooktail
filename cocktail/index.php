					...
					<div id="main">
						<div class="inner">
							<header>
								...
								<p>Brisez les chaînes de la sobriété et embrassez l'extase enivrante de l'alcool. La vie est trop courte pour rester sobre, plongez dans un tourbillon de plaisirs liquides et laissez chaque goutte vous libérer de l'ennui quotidien.</p>
							</header>
							<section class="tiles">
